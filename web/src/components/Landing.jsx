  ...
  return (
    <div className="relative min-h-[100svh] pb-16">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(to top, #000 22%, rgba(0,0,0,0.82) 48%, transparent 100%)",
        }}
      />

      <div className="relative max-w-sm space-y-6">
        <p className="text-[15px] leading-relaxed text-[var(--color-mute)]">
          Photograph a meal and Macro names every food in it, then takes the numbers from a
          nutrition database rather than guessing them. Train to a programme that reads what you
          lifted last week. Watch the trend, not the scale.
        </p>
        ...
        {local ? (
          <div className="space-y-3">
            ...
            <p className="text-[11px] leading-relaxed text-[var(--color-mute)]">
              No account needed. This deployment has no Firebase or Supabase project connected, so
              Macro runs entirely in this browser — your targets, your diary and your figure all
              work, and stay on this device. Photo recognition and Macro AI need the backend; see
        ...
        {!local && (
          <p className="text-[11px] leading-relaxed text-[var(--color-mute)]">
            Your food, your training and your photos stay yours. Progress photos are stored
            privately and are never sent to the AI.
          </p>
        )}
      </div>
    </div>
