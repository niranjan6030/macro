        ...
        {turns.length === 0 && (
          <div className="space-y-3 pt-2">
            <p className="text-sm leading-relaxed text-[var(--color-mute)]">
              Ask about your day, your food or your training. Macro AI can see what you have logged,
              and looks nutrition up rather than guessing it — every figure it quotes came from a
              database, not its memory.
            </p>
