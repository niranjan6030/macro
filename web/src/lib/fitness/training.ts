...
export interface Exercise {
  ...
  compound: boolean;
  /** Where this exercise is most productive. */
...
export const EXERCISES: Exercise[] = [
  // Chest
  { id: "bench", name: "Barbell bench press", primary: "chest", secondary: ["triceps", "shoulders"], equipment: "barbell", compound: true, repRange: [5, 8], cue: "Shoulder blades pinned back, bar to the lower chest, elbows about 45°." },
  { id: "db-press", name: "Dumbbell bench press", primary: "chest", secondary: ["triceps", "shoulders"], equipment: "dumbbell", compound: true, repRange: [8, 12], cue: "Lower until the dumbbells are level with your chest, then drive up and slightly together." },
  { id: "incline-db", name: "Incline dumbbell press", primary: "chest", secondary: ["shoulders", "triceps"], equipment: "dumbbell", compound: true, repRange: [8, 12], cue: "Bench at 30°. Any steeper and it becomes a shoulder press." },
  { id: "fly", name: "Cable fly", primary: "chest", secondary: [], equipment: "cable", compound: false, repRange: [12, 15], cue: "Soft elbows, fixed angle. Think of hugging, not pressing." },
  { id: "pushup", name: "Push-up", primary: "chest", secondary: ["triceps", "core"], equipment: "bodyweight", compound: true, repRange: [10, 20], cue: "Straight line from head to heels. Chest to the floor, not just the nose." },
  // Back
  { id: "deadlift", name: "Barbell deadlift", primary: "back", secondary: ["hamstrings", "glutes", "core"], equipment: "barbell", compound: true, repRange: [3, 6], cue: "Bar over mid-foot, lats tight, push the floor away. Stop the set when the back rounds." },
  { id: "row", name: "Barbell row", primary: "back", secondary: ["biceps"], equipment: "barbell", compound: true, repRange: [6, 10], cue: "Torso around 45°, pull to the navel, no heaving with the lower back." },
  { id: "pullup", name: "Pull-up", primary: "back", secondary: ["biceps"], equipment: "bodyweight", compound: true, repRange: [5, 12], cue: "Full hang at the bottom, chin clearly over the bar at the top." },
  { id: "lat-pulldown", name: "Lat pulldown", primary: "back", secondary: ["biceps"], equipment: "cable", compound: true, repRange: [8, 12], cue: "Drive the elbows down and back. The bar comes to the collarbone." },
  { id: "cable-row", name: "Seated cable row", primary: "back", secondary: ["biceps"], equipment: "cable", compound: true, repRange: [10, 15], cue: "Chest up, no rocking. Squeeze at the ribs for a beat." },
  // Shoulders
  { id: "ohp", name: "Overhead press", primary: "shoulders", secondary: ["triceps", "core"], equipment: "barbell", compound: true, repRange: [5, 8], cue: "Squeeze the glutes, move the head back as the bar passes, finish with the bar over the ears." },
  { id: "db-shoulder", name: "Dumbbell shoulder press", primary: "shoulders", secondary: ["triceps"], equipment: "dumbbell", compound: true, repRange: [8, 12], cue: "Stop just short of locking out to keep the tension on the delts." },
  { id: "lateral", name: "Lateral raise", primary: "shoulders", secondary: [], equipment: "dumbbell", compound: false, repRange: [12, 20], cue: "Light weight, lead with the elbows, stop at shoulder height. Do not swing." },
  { id: "face-pull", name: "Face pull", primary: "shoulders", secondary: ["back"], equipment: "cable", compound: false, repRange: [15, 20], cue: "Pull to the forehead, rotate outwards. The best insurance a bench press has." },
  // Legs
  { id: "squat", name: "Barbell back squat", primary: "quads", secondary: ["glutes", "hamstrings", "core"], equipment: "barbell", compound: true, repRange: [5, 8], cue: "Brace before you descend, knees tracking over the toes, hips to at least parallel." },
  { id: "front-squat", name: "Front squat", primary: "quads", secondary: ["core", "glutes"], equipment: "barbell", compound: true, repRange: [5, 8], cue: "Elbows high throughout. The moment they drop, the bar follows." },
  { id: "leg-press", name: "Leg press", primary: "quads", secondary: ["glutes"], equipment: "machine", compound: true, repRange: [10, 15], cue: "Do not let the lower back lift off the pad at the bottom." },
  { id: "rdl", name: "Romanian deadlift", primary: "hamstrings", secondary: ["glutes", "back"], equipment: "barbell", compound: true, repRange: [8, 12], cue: "Push the hips back with a flat back. Stop where the stretch stops, not where the floor is." },
  { id: "lunge", name: "Walking lunge", primary: "quads", secondary: ["glutes", "hamstrings"], equipment: "dumbbell", compound: true, repRange: [10, 15], cue: "Long stride for glutes, short stride for quads. Per leg." },
  { id: "leg-curl", name: "Lying leg curl", primary: "hamstrings", secondary: [], equipment: "machine", compound: false, repRange: [10, 15], cue: "Slow on the way back — that is where hamstrings actually grow." },
  { id: "hip-thrust", name: "Hip thrust", primary: "glutes", secondary: ["hamstrings"], equipment: "barbell", compound: true, repRange: [8, 12], cue: "Chin tucked, ribs down, full lockout with a hard squeeze at the top." },
  { id: "calf-raise", name: "Standing calf raise", primary: "calves", secondary: [], equipment: "machine", compound: false, repRange: [12, 20], cue: "Full stretch at the bottom, pause at the top. Calves need the range." },
  // Arms
  { id: "curl", name: "Barbell curl", primary: "biceps", secondary: [], equipment: "barbell", compound: false, repRange: [8, 12], cue: "Elbows stay at your sides. If the shoulders move, it is too heavy." },
  { id: "hammer", name: "Hammer curl", primary: "biceps", secondary: [], equipment: "dumbbell", compound: false, repRange: [10, 15], cue: "Neutral grip. This is the one that builds the thickness of the arm." },
  { id: "skull", name: "Lying triceps extension", primary: "triceps", secondary: [], equipment: "barbell", compound: false, repRange: [10, 15], cue: "Upper arms stay still. Lower to the forehead, not the chest." },
  { id: "pushdown", name: "Cable triceps pushdown", primary: "triceps", secondary: [], equipment: "cable", compound: false, repRange: [12, 15], cue: "Lock the elbows to your ribs and open only from there." },
  { id: "dip", name: "Dip", primary: "triceps", secondary: ["chest", "shoulders"], equipment: "bodyweight", compound: true, repRange: [6, 12], cue: "Upright for triceps, leaning forward for chest. Do not go below a painful shoulder stretch." },
  // Core
...
export type SplitName = "full_body" | "upper_lower" | "push_pull_legs" | "arnold";
...
interface SplitDef {
  label: string;
  /** How many training days this split is designed around. */
  days: number;
  blurb: string;
 ...
 */
export const SPLITS: Record<SplitName, SplitDef> = {
  full_body: {
    label: "Full body",
    days: 3,
    blurb: "Everything, three times a week. The most efficient use of three days there is.",
    sessions: [
      { name: "Full body A", focus: ["quads", "chest", "back"], exerciseIds: ["squat", "bench", "row", "lateral", "plank"] },
      { name: "Full body B", focus: ["hamstrings", "back", "shoulders"], exerciseIds: ["rdl", "lat-pulldown", "ohp", "curl", "calf-raise"] },
      { name: "Full body C", focus: ["quads", "chest", "back"], exerciseIds: ["leg-press", "incline-db", "cable-row", "pushdown", "hanging-leg"] },
    ],
  },
  upper_lower: {
    label: "Upper / lower",
    ...
    sessions: [
      { name: "Upper A", focus: ["chest", "back", "shoulders"], exerciseIds: ["bench", "row", "ohp", "lat-pulldown", "curl", "pushdown"] },
      { name: "Lower A", focus: ["quads", "hamstrings", "glutes"], exerciseIds: ["squat", "rdl", "leg-press", "calf-raise", "hanging-leg"] },
      { name: "Upper B", focus: ["chest", "back", "shoulders"], exerciseIds: ["incline-db", "pullup", "db-shoulder", "cable-row", "hammer", "skull"] },
      { name: "Lower B", focus: ["hamstrings", "glutes", "quads"], exerciseIds: ["deadlift", "lunge", "leg-curl", "hip-thrust", "plank"] },
    ],
  },
  push_pull_legs: {
    ...
    sessions: [
      { name: "Push A", focus: ["chest", "shoulders", "triceps"], exerciseIds: ["bench", "db-shoulder", "incline-db", "lateral", "pushdown"] },
      { name: "Pull A", focus: ["back", "biceps"], exerciseIds: ["deadlift", "pullup", "cable-row", "face-pull", "curl"] },
      { name: "Legs A", focus: ["quads", "hamstrings", "calves"], exerciseIds: ["squat", "rdl", "leg-press", "calf-raise", "plank"] },
      { name: "Push B", focus: ["chest", "shoulders", "triceps"], exerciseIds: ["ohp", "db-press", "fly", "lateral", "dip"] },
      { name: "Pull B", focus: ["back", "biceps"], exerciseIds: ["row", "lat-pulldown", "face-pull", "hammer", "hanging-leg"] },
      { name: "Legs B", focus: ["hamstrings", "glutes", "quads"], exerciseIds: ["front-squat", "hip-thrust", "leg-curl", "lunge", "calf-raise"] },
    ],
  },
  arnold: {
    ...
    sessions: [
      { name: "Chest & back", focus: ["chest", "back"], exerciseIds: ["bench", "row", "incline-db", "pullup", "fly"] },
      { name: "Shoulders & arms", focus: ["shoulders", "biceps", "triceps"], exerciseIds: ["ohp", "lateral", "face-pull", "curl", "skull"] },
      { name: "Legs", focus: ["quads", "hamstrings", "calves"], exerciseIds: ["squat", "rdl", "leg-press", "leg-curl", "calf-raise"] },
      { name: "Chest & back II", focus: ["chest", "back"], exerciseIds: ["db-press", "lat-pulldown", "dip", "cable-row", "fly"] },
      { name: "Shoulders & arms II", focus: ["shoulders", "biceps", "triceps"], exerciseIds: ["db-shoulder", "lateral", "hammer", "pushdown", "hanging-leg"] },
      { name: "Legs II", focus: ["hamstrings", "glutes", "quads"], exerciseIds: ["deadlift", "hip-thrust", "lunge", "leg-curl", "calf-raise"] },
    ],
  },
};

/** The split that suits this many training days. */
export function splitFor(daysPerWeek: number): SplitName {
 ...
 */
export function weekPlan(daysPerWeek: number, split?: SplitName): (SessionTemplate | null)[] {
  ...
  const slots: (SessionTemplate | null)[] = Array(7).fill(null);
  const chosen: number[] = [];
...
export interface SetLog {
  weightKg: number;
  reps: number;
  /** Reps in reserve — how many more they could have done. 0 = to failure. */
  rir?: number | null;
}
...
export interface Prescription {
  ...
  /** Why this is what it is, in one line, shown next to the prescription. */
  reason: string;
}
...
export const volume = (sets: SetLog[]): number =>
  Math.round(sets.reduce((t, s) => t + s.weightKg * s.reps, 0));
 ...
 */
export function nextPrescription(ex: Exercise, last: SetLog[] | null): Prescription {
  ...
  if (allHitTop) {
    ...
    const step = ex.compound
      ? (["quads", "hamstrings", "glutes", "back"] as Muscle[]).includes(ex.primary) ? 5 : 2.5
      : 2.5;
    return {
      sets,
      reps: lo,
  ...
  if (anyFailedLow) {
    ...
    return {
      sets, reps: lo, weightKg: topWeight,
  ...
  if (avgRir >= 4) {
    return {
      sets, reps: hi, weightKg: round(topWeight * 1.05),
...
const round = (kg: number) => Math.round(kg / 1.25) * 1.25;
